...
@Dependent
@Slf4j
public class StockManagerCollectionItemDetailsFallbackHandler implements FallbackHandler<Collection<ItemDetails>> {
	 ...
	 */
	@Override
	public Collection<ItemDetails> handle(ExecutionContext context) {
